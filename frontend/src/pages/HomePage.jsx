...
const serviceCards = [
  { title: "Resume ATS Repair", subtitle: "Shortlist-ready resume rewrite", price: "INR 199", cta: "Fix My Resume", accent: "border-brand-400", button: "bg-brand-600 text-white hover:bg-brand-700", features: ["ATS format correction", "Achievement bullet rewrite", "Skills and keyword mapping", "Recruiter-readable positioning"], icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" },
  { title: "Job Alert Lane", subtitle: "Relevant openings filter", price: "INR 99", cta: "Start Alerts", accent: "border-cyan-400", button: "bg-cyan-600 text-white hover:bg-cyan-700", features: ["Pan-India job roles", "Experience-fit filters", "Role-fit priority queue", "Daily WhatsApp action list"], icon: "M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" },
  { title: "Interview Prep", subtitle: "Technical plus HR answers", price: "INR 149", cta: "Start Prep", accent: "border-amber-400", button: "bg-amber-500 text-ink hover:bg-amber-400", features: ["Tell me about yourself", "Project and experience scripts", "Role-specific questions", "Confident answer structure"], icon: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" },
  { title: "Mock Interview", subtitle: "Live fresher simulation", price: "INR 299", cta: "Book Mock", accent: "border-rose-400", button: "bg-rose-600 text-white hover:bg-rose-700", features: ["Technical plus HR round", "Communication scorecard", "Weakness heatmap", "7-day correction plan"], icon: "M15 10l4.553-2.069A1 1 0 0121 8.82V15.18a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" },
  { title: "Naukri + LinkedIn Boost", subtitle: "Recruiter visibility setup", price: "INR 149", cta: "Boost Profile", accent: "border-indigo-400", button: "bg-indigo-600 text-white hover:bg-indigo-700", features: ["Naukri headline and keywords", "LinkedIn About rewrite", "GitHub link presentation", "Recruiter search readiness"], icon: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" },
  { title: "Project Proof Track", subtitle: "Portfolio upgrade for freshers", price: "INR 499", cta: "Upgrade Project", accent: "border-orange-400", button: "bg-orange-500 text-white hover:bg-orange-600", features: ["Project selection guidance", "README and demo story", "Resume project narrative", "Interview question mapping"], icon: "M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" },
];
